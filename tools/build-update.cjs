...
const payload={skySource:text('src/sky.js'),rendererSource:text('src/renderer.js'),skyImage:'data:image/webp;base64,'+fs.readFileSync(path.join(root,'assets/universe-optimized.webp')).toString('base64')};
