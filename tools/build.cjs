/* v0.16: the website works as supplied. This optional build makes one offline HTML. */
'use strict';
...
try{
 ...
 if(version!=='0.16')throw Error('This builder requires package version 0.0.16.');
