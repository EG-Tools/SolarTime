...
function putR2(root,{bucket,key,file,type,cacheControl='public, max-age=31536000, immutable'}){
 ...
 const result=spawnSync(process.execPath,[bin,'r2','object','put',bucket+'/'+key,'--remote','--file',file,'--content-type',type,'--cache-control',cacheControl,'--force'],{cwd:root,stdio:'inherit'});
