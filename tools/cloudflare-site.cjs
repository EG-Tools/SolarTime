...
function prepareSite(root,{manifest=null,deployment=null,cdnBase=null}={}){
 ...
 const mediaBase=cdnBase==null?(deployment.cdnBase||'/media/'):cdnBase;
 const scripts=runtimeScripts(root,manifest,deployment,{cdnBase:mediaBase});
 ...
 for(const file of ['index.html','styles.css','version.json','manifest.webmanifest','apple-touch-icon.png','app-icon-192.png','app-icon-512.png','life-user-watermark.webp','kakao-pay-qr.svg'])copy(file);
