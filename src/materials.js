/* Solar Time v0.12: one owner for optional public image maps and their local cache.
...
class Materials {
 ...
 download(){if(this.exporting)return this.exporting;this.exporting=(async()=>{
  ...
  const url=URL.createObjectURL(new Blob([html],{type:'text/html;charset=utf-8'})),a=document.createElement('a');a.href=url;a.download='SolarTime_v0.12_photos.html';a.click();
