...
(function(root){
  ...
  function detect(){
    ...
    for(const [prefix,language] of [['zh','chn'],['ja','jpn'],['ko','kor'],['en-gb','eu'],['hi','hi'],['es-mx','mx'],['es','es'],['de','de'],['fr','fr'],['pt-br','br'],['pt','pt'],['it','it']])if(languages.some(value=>value===prefix||value.startsWith(prefix+'-')))return language;
    return 'en';
  }
