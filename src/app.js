/* Solar Time v0.58 — app implementation owner. */
(function () {
  'use strict';
  ...
  async function init() {
    try {
      ...
      function loadReleaseNotes(){
        ...
        return UI.loadScript('src/release-notes.js?v=0.58-r1','SolarReleaseNotes').then(api=>{if(!releaseNotesApi){releaseNotesApi=api;releaseNotesNavigator=api.createReleaseNotesNavigator();}return releaseNotesApi;});
      }
