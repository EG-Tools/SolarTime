...
(function () {
  ...
  const COPY={
    kor:{
      ...
      apply:'이동',save:'저장',delete:'삭제',cancel:'취소',helpClose:'도움말 닫기',helpTitle:'사용 방법과 계산 기준',basicControls:'기본 조작',supportMessage:'☕ 이 프로그램이 도움이 되셨다면 커피 한 잔을 후원해 주세요!',supportKrw:'원화로 후원',supportUsd:'달러로 후원',
    ...
    en:{
      ...
      apply:'Move',save:'Save',delete:'Delete',cancel:'Cancel',helpClose:'Close help',helpTitle:'Guide and calculation notes',basicControls:'Basic controls',supportMessage:'☕ If Solar Time has been helpful, consider supporting it with a coffee!',supportKrw:'Support in KRW',supportUsd:'Support in USD',
    ...
    chn:{
      ...
      apply:'移动',save:'保存',delete:'删除',cancel:'取消',helpClose:'关闭帮助',helpTitle:'使用方法与计算说明',basicControls:'基本操作',supportMessage:'☕ 如果 Solar Time 对您有所帮助，欢迎请我们喝杯咖啡！',supportKrw:'韩元赞助',supportUsd:'美元赞助',
    ...
    jpn:{
      ...
      apply:'移動',save:'保存',delete:'削除',cancel:'キャンセル',helpClose:'ヘルプを閉じる',helpTitle:'操作方法と計算基準',basicControls:'基本操作',supportMessage:'☕ Solar Timeがお役に立てたら、コーヒー一杯分のご支援をお願いします！',supportKrw:'韓国ウォンで支援',supportUsd:'米ドルで支援',
  ...
  Object.assign(COPY,{
    hi:{...COPY.en,
      ...
      apply:'जाएँ',save:'सहेजें',delete:'हटाएँ',cancel:'रद्द करें',helpClose:'सहायता बंद करें',helpTitle:'उपयोग और गणना मार्गदर्शिका',basicControls:'मूल नियंत्रण',supportMessage:'☕ यदि Solar Time आपके लिए उपयोगी रहा है, तो एक कॉफ़ी के साथ सहयोग करें!',supportKrw:'KRW में सहयोग',supportUsd:'USD में सहयोग',
    ...
    es:{...COPY.en,
      ...
      apply:'Mover',save:'Guardar',delete:'Eliminar',cancel:'Cancelar',helpClose:'Cerrar ayuda',helpTitle:'Guía y criterios de cálculo',basicControls:'Controles básicos',supportMessage:'☕ Si Solar Time te ha resultado útil, puedes invitarnos a un café.',supportKrw:'Apoyar en KRW',supportUsd:'Apoyar en USD',
    ...
    de:{...COPY.en,
      ...
      apply:'Bewegen',save:'Speichern',delete:'Löschen',cancel:'Abbrechen',helpClose:'Hilfe schließen',helpTitle:'Bedienung und Berechnungsgrundlagen',basicControls:'Grundsteuerung',supportMessage:'☕ Wenn Solar Time hilfreich war, freuen wir uns über einen Kaffee.',supportKrw:'In KRW unterstützen',supportUsd:'In USD unterstützen',
    ...
    fr:{...COPY.en,
      ...
      apply:'Déplacer',save:'Enregistrer',delete:'Supprimer',cancel:'Annuler',helpClose:'Fermer l’aide',helpTitle:'Guide et principes de calcul',basicControls:'Commandes de base',supportMessage:'☕ Si Solar Time vous a été utile, vous pouvez nous offrir un café.',supportKrw:'Soutenir en KRW',supportUsd:'Soutenir en USD',
