  ...
  async function init() {
    try {
      ...
      function loadReleaseNotes(){
        ...
        return UI.loadScript('src/release-notes.js?v=0.56-r2','SolarReleaseNotes').then(api=>{if(!releaseNotesApi){releaseNotesApi=api;releaseNotesNavigator=api.createReleaseNotesNavigator();}return releaseNotesApi;});
      }
