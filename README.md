...
대형 시계 자동 맞춤, 정지 화면 렌더링과 천체 계산 재사용, 단계별 텍스처 로딩 및 배포 검증을 개선했습니다. Microsoft Clarity는 사용자가 쿠키를 허용한 뒤에만 로드되며, 거부로 변경하면 분석 저장 동의도 철회됩니다.
