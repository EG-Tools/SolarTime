...
def suite(browser,root,size,installed):
 ...
 page.locator('#release-notes-newer').click();page.locator('#release-notes-newer').click();check(page.locator('#release-notes-version').inner_text()=='v0.51',tag+' current release navigation')
