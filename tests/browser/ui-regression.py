...
def suite(browser,root,size,installed):
 ...
 if size==(1280,800):
  ...
  page.locator('#live-button').click();page.locator('#body-close').click()
 ...
 check(page.locator('#release-notes-version').inner_text()=='v0.50',tag+' visible release version')
 check(page.locator('#release-notes-list li').count()==6 and 'Auto Language' in page.locator('#release-notes-list').inner_text(),tag+' visible English SG release note')
 page.locator('#release-notes-older').click();check(page.locator('#release-notes-version').inner_text()=='v0.48',tag+' previous release navigation')
 ...
 page.locator('#release-notes-newer').click();page.locator('#release-notes-newer').click();check(page.locator('#release-notes-version').inner_text()=='v0.50',tag+' current release navigation')
