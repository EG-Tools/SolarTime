...
with sync_playwright() as pw:
    ...
    page.locator('#fit-view').click();page.wait_for_timeout(80)
    check('Overview button clears tracking and restores the requested lower composition',page.evaluate('SolarTime.renderer.camera.focus===null&&SolarTime.renderer.camera.zoom===1') and page.locator('#focus-reset').count()==0)
    page.locator('#body-close').click()
