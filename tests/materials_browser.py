...
report = {'version':'0.12','mode':'synthetic fetch fixtures; no live source downloads',
...
(ROOT/'docs/materials-browser-v0.12.json').write_text(json.dumps(report,ensure_ascii=False,indent=2))
